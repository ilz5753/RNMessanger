...
export let pos = {
  isAndroid: isEqual(OS, "android"),
  isIOS: isEqual(OS, "ios"),
  isMac: isEqual(OS, "macos"),
  isWindows: isEqual(OS, "windows"),
  isWeb: isEqual(OS, "web"),
};
...
export let MAR = 19;
/**
 * double of default margin
 */
export let DMAR = MAR * 2;
/**
 * width without dmar
 */
export let WWDMAR = dim.width - DMAR;
/**
 * height without dmar
 */
export let HWDMAR = dim.height - DMAR;
/**
 * wwdmar width style
 */
export let WWDMARStyle = width(WWDMAR);
/**
 * wwdmar height style
 */
export let HWDMARStyle = height(HWDMAR);

export let br10 = borderRadius("", 10);
export let bwh = borderWidth("", 0.5);
...
export let zi1 = zIndex(1);
export let overlay = [pa, zi1];
...
/**
 * touchable highlight underlay color
 */
export let thuc = "rgba(0,0,0,0.177)";
...
export let AuthInputLayout = layout(360, 48);
